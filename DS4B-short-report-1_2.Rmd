...
# **From Citizen Sceience: Exlporing Number of Frog Species in Australia**
...
ggplot() +
  ...
  labs(
    ...
    subtitle = "Novenmber 2017 to Novernmber 2021"
    ) +
  theme_minimal() +
...
ggplot(data = dt_sp_yr_st_distinct, aes(x = as.numeric(year), y = total_number_species_found)) +
  ...
  labs(x = "Year", 
       y = "Cumulative Number of Distinct Species", 
       title = "Species Discovery Curves by Australia Sate") +
  theme_minimal() +
  facet_wrap(~state)
